...
final class Aero_MeshAnimatedDraw {
    ...
    static boolean tryBonePages(boolean forcePrecise, Aero_AnimationClip clip,
            Aero_MeshModel model, Aero_MeshModel.NamedGroup[] entries,
        ...
        if (forcePrecise) return false;
        if (clip != null && clip.hasUvAnimation()) return false;
