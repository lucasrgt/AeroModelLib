...
static void renderAnimated(Aero_MeshModel model,
        ...
        Aero_EntityModelRenderer.renderAnimated(model, state, x, y, z, yaw, entity.getEntityBrightness(partialTick), partialTick, transform);
    }
...
static void renderAnimated(Aero_MeshModel model,
                                      ...
                                      float yaw, float partialTick,
                                      Aero_EntityModelTransform transform) {
        Aero_EntityModelRenderer.renderAnimated(model, bundle, def, state, x, y, z, yaw, entity.getEntityBrightness(partialTick), partialTick, transform);
    }
